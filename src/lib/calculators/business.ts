...
export const businessCalculators: CalculatorMeta[] = [
  {
    ...
    fields: [
      ...
      { id: "price", label: "Price", type: "number", defaultValue: 55, prefix: "$" },
      { id: "marginPct", label: "Margin %", type: "number", defaultValue: 25, suffix: "%" },
      { id: "markupPct", label: "Markup %", type: "number", defaultValue: 37.5, suffix: "%" },
    ],
