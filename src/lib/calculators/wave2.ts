...
export const wave2Calculators: CalculatorMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "p", label: "P (atm)", type: "number", defaultValue: 1 },
      { id: "v", label: "V (L)", type: "number", defaultValue: 22.4 },
      { id: "n", label: "n (mol)", type: "number", defaultValue: 1 },
      { id: "t", label: "T (K)", type: "number", defaultValue: 273.15 },
    ],
