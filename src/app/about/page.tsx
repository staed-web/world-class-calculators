  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 prose prose-slate">
      ...
      <p className="mt-2 text-muted leading-relaxed">
        ...
        Currency rates are periodically refreshed from a free reference feed (with a fallback snapshot if unavailable) and are for education only — not for trading.
      </p>
    </div>
  );
}
